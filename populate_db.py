...
def populate_db():
    ...
    with app.app_context():
        ...
        # Add sample students (for admin management)
        students = [
        ...
        for student in students:
            ...
            if not existing:
                if student.email == 'admin@edulib.com':
                    ...
                    student.set_password('password123')  # default password for students
        ...
        # Add sample borrowings for demonstration
        from datetime import datetime, timedelta
        import random

        # For alice, add some returned borrowings
        ...
        if alice:
            ...
            for i, book in enumerate(books_for_alice):
                ...
                book.available_quantity += 1  # since returned
