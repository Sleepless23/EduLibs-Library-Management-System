...
def dashboard():
    ...
    # Recommendations: popular books or by genre (simple: most borrowed)
...
def students():
    ...
    # Add borrowing info to each student
...
def delete_student(id):
    ...
    # Delete all borrowing records for this student first
